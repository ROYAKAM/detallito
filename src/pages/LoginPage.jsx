      ...
      <div className="min-h-dvh flex items-center justify-center px-4 sm:px-6">
        <div ref={cardRef} className="w-full max-w-sm pixel-border bg-farm-800 p-5 sm:p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-sdvcream-200 mt-2 font-body">Solo tu sabes la respuesta...</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-sdvcream-200 hover:text-sdvgold-500 font-body text-lg transition-colors"
              >
                {showPw ? 'Ocultar' : 'Ver'}
              </button>
            </div>
          ...
          <button
            ...
            className="w-full mt-4 text-sdvcream-200 hover:text-sdvgold-400 font-body text-lg transition-colors"
          >
          ...
          {hintIdx >= 0 && (
            <div className="mt-3 pixel-border bg-farm-700 p-3">
              <p className="text-center text-sdvcream-100 font-body text-lg italic">
